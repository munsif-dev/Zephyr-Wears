...
-- Fix ProductImage table - rename alt to altText
DO $$
BEGIN
    IF EXISTS (
...
-- Add productId column to OrderItem if it doesn't exist
ALTER TABLE "OrderItem" ADD COLUMN IF NOT EXISTS "productId" TEXT NOT NULL DEFAULT '';

-- Remove unused Review columns
...
-- Remove unused ProductVariant columns
