...
-- CreateEnum
CREATE TYPE "LayerType" AS ENUM ('TEXT', 'IMAGE', 'SHAPE');
...
-- CreateIndex
CREATE INDEX "DesignLayer_designId_idx" ON "DesignLayer"("designId");
...
-- CreateIndex
CREATE UNIQUE INDEX "CartItem_userId_variantId_designId_key" ON "CartItem"("userId", "variantId", "designId");
